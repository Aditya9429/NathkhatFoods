        ...
        <div className='mt-10'>
            <div className='flex flex-col items-center gap-10'>
                <div className=' text-center'>
                    <h1 className='text-4xl lg:text-8xl my-font'>Our Media </h1>
                    <p className='max-w-[350px] mt-4 text-center'>We consider all the drivers of change gives you the components you need to change to create a truly happens.</p>
                </div>
