  ...
  return (
    <div className='w-full flex flex-wrap items-center justify-center mt-10 mb-44 px-4 gap-30'>
      <div className='flex items-center justify-between  relative '>
        ...
        <div className='flex  items-start  w-[78%] h-[60%] lg:w-[60%] lg:h-[80%] absolute top-1/2 left-[37%] lg:top-[80%] lg:left-[48%] bg-[#474747] py-4  rounded-2xl'>
          <div className='flex flex-col gap-2 px-8 lg:py-5 lg:gap-3'>
            ...
            <div className='flex items-center gap-4 mb-3 '>
              ...
              <p className='gap-3 text-gray-300 font-semibold'> 9654469604</p>

            </div>
            <div className='flex items-center gap-4 mb-3'>
              <span><FiMessageCircle className='text-white'/></span>
              <p className='gap-3 text-gray-300 font-semibold text-lg'>nathkhat23@gmail.com</p>

            </div>
            <div className='flex items-center gap-4'>
              <span><FiMapPin className='text-white'/></span>
              <p className='gap-3 text-gray-300 font-semibold'>81-A,Syria Ist Lane,Yria-14321</p>
      ...
      <div className='w-full flex flex-col items-start gap-4 max-w-[500px]   ml-8 px-3 py-3 lg:mt-40'>
        <h1 className='text-5xl font-semibold my-font'>We provide healthy food for your family</h1>
        <p className='text-shadow-amber-200 text-lg text-[#281f1f]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt non atque suscipit ut ipsa
          asperiores libero nemo impedit! Blanditiis voluptates suscipit ad iusto, nihil culpa quod incidunt accusamus a beatae.</p>
        <p className='text-lg text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi cupiditate numquam harum vel ab asperiores facilis eos nesciunt.
